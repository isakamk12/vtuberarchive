document.addEventListener('DOMContentLoaded', () => {
    ...
    const agencies = [
        ...
        // ── GLOBAL (稼働中) ──
        { name: "3AM", sub: "スリーエーエム", filter: "global", color: "80, 100, 200", icon: "3", url: "3AM/threeam_index.html", tags: ["EN", "Agency"], desc: "夜の時間帯をターゲットにしたコンセプト。公式サイトは英語で運営され、深夜帯の配信スケジュールが中心。" },
