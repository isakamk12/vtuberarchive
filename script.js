...
const agencies = [
        ...
        {
            name: "ステラバース",
            name_en: "Stellahverse",
            name_es: "Stellahverse",
            name_zh: "Stellahverse (Japan)",
            name_ko: "스텔라 버스 (Stellahverse Japan)",
            sub: "Stellahverse / JP",
            filter: "indie",
            color: "253, 224, 71",
            icon: "S",
            url: "Stellahverse/stellaverse_index.html",
            tags: ["Agency", "JP"],
            desc: "「時間と空間を超えて集まったアイドル」をコンセプトにする日本のVTuber事務所。独自の物語性と個性豊かなメンバーが特徴。",
            desc_en: "A Japanese VTuber agency with the concept of 'idols gathered across time and space'. Features unique storytelling and diverse members.",
            desc_es: "Una agencia japonesa de VTubers con el concepto de 'idols reunidos a través del tiempo y el espacio'. Destaca por su narrativa única.",
            desc_zh: "以“超越时空汇聚而成的偶像”为理念的日本VTuber事务所。以独特的叙事性和个性丰富的成员为特征。",
            desc_ko: "「시간과 공간을 초월하여 모인 아이돌」을 컨셉으로 하는 일본의 VTuber 사무소입니다. 독자적인 이야기성과 개성 넘치는 멤버들이 특징입니다."
        },
        {
            name: "すぺしゃりて",
            name_en: "Specialite",
        ...
        },
        {
            ...
            color: "71, 71, 235",
            icon: "V",
            url: "VERSE/verse_index.html",
            tags: ["Sony", "Music", "Story"],
            desc: "ソニー・ミュージック協力。カシ・オトハ等、物語連動の固有キャラクターが活動中。音楽と物語がクロスオーバーする世界観が特徴。",
            desc_en: "Sony Music collaboration. Character activities are integrated with a story. Features a unique crossover of music and narrative.",
            desc_es: "Colaboración con Sony Music. Personajes como Kashi Otoha operan dentro de una narrativa. Mezcla música y storytelling.",
            desc_zh: "索尼音乐合作。以歌手卡希·音羽为代表，各具特色的角色在与故事联动的世界中活动。特点是音乐与故事的跨界融合。",
            desc_ko: "소니 뮤직 협력. 카시 오토하 등 이야기와 연동된 개성 넘치는 캐릭터들이 활동 중입니다. 음악과 이야기의 크로스오버 세계관이 특징입니다."
        },
        {
            name: "いろどり芸能郵便社",
            name_en: "Irodori Entertainment Post",
            name_es: "Irodori Entertainment Post",
            name_zh: "色彩艺能邮便社",
            name_ko: "이로도리 예능 우편사",
            sub: "Bushiroad",
            filter: "corporate",
            color: "116, 184, 121",
            icon: "I",
            url: "Irodori/irodori_index.html",
            tags: ["Bushiroad", "Agency", "Drama"],
            desc: "ブシロード運営。服部美希など、独自のVTuberモデルを持つタレントが所属し、声優活動やドラマ展開を軸に活動。",
            desc_en: "Operated by Bushiroad. Home to talent with unique VTuber models like Miki Hattori, focusing on voice acting and drama.",
            desc_es: "Operado por Bushiroad. Hogar de talentos con modelos únicos como Miki Hattori, centrados en la actuación de voz.",
            desc_zh: "武士道（Bushiroad）运营。所属艺人如服部美希等拥有独特的专属模型，以声优活动和剧情内容为轴心开展工作。",
            desc_ko: "부시로드 운영. 핫토리 미키 등 독자적인 버추얼 유튜버 모델을 가진 탤런트들이 소속되어 있으며, 성우 활동과 드라마 제작을 중심으로 활동합니다."
        },
        {
            name: "GEMS COMPANY",
            name_en: "GEMS COMPANY",
            name_es: "GEMS COMPANY",
            name_zh: "GEMS COMPANY",
            name_ko: "젬즈 컴퍼니 (GEMS COMPANY)",
            sub: "ジェムズカンパニー / SQEX",
            filter: "corporate",
            color: "0, 191, 255",
            icon: "G",
            url: "GEMSCompany/gems_index.html",
            tags: ["Square Enix", "3D", "Idol"],
            desc: "スクウェア・エニックス直営。星菜日向夏など、全員が固有の高品質3Dモデルを持つ。アイドルとしてのライブ活動に定評がある。",
            desc_en: "Directly managed by Square Enix. All members, including Hinata Hoshina, have high-quality 3D models. Renowned for idol concerts.",
            desc_es: "Gestionado por Square Enix. Todos los miembros tienen modelos 3D de alta calidad. Conocidos por sus conciertos de idols.",
            desc_zh: "史克威尔艾尼克斯（SQEX）直营。所有成员如星菜日向夏等都拥有专属的高品质3D模型。作为偶像的Live活动广受好評。",
            desc_ko: "스퀘어 에닉스 직영. 호시나 히나타 등 모든 멤버가 고품질의 고유 3D 모델을 보유하고 있습니다. 아이돌로서의 라이브 활동으로 정평이 나 있습니다."
        },
        {
            name: "GuildB",
            name_en: "GuildB",
        ...
        },
        {
            ...
            name_es: "LightUp",
            name_zh: "LightUp",
            name_ko: "라이트 업! (LightUp)",
            sub: "らいとあっぷ！",
            filter: "corporate",
            color: "255, 230, 0",
            icon: "L",
            url: "LightUp/lightup_index.html",
            tags: ["Agency", "JP", "Variety"],
            desc: "複数の期生が独自のLive2Dモデルで配信活動を継続中。タレント間の仲の良さと、多様な企画力で着実にファンを増やしている。",
            desc_en: "Multiple generations continue streaming with unique Live2D models. Steadily growing with strong member bonds and creative content.",
            desc_es: "Múltiples generaciones transmiten con modelos Live2D únicos. Crecen constantemente gracias a su creatividad y la unión entre sus miembros.",
            desc_zh: "拥有多期成员，以独特的Live2D模型持续进行直播活动。凭借艺人间的紧密关系和多样的企划力稳步增加粉丝。",
            desc_ko: "여러 기수의 멤버들이 독자적인 Live2D 모델로 방송 활동을 계속하고 있습니다. 탤런트 간의 우애와 다양한 기획력으로 착실히 팬을 늘려가고 있습니다."
        },
        {
            name: "ゆにゆにっ！",
            name_en: "UniUni",
            name_es: "UniUni",
            name_zh: "UniUni",
            name_ko: "유니유니っ! (UniUni)",
            sub: "ゆにゆにっ！",
            filter: "indie",
            color: "255, 120, 180",
            icon: "U",
            url: "UniUni/uniuni_index.html",
            tags: ["Concept", "JP", "Cute"],
            desc: "独自のコンセプトとモデルを持つタレントが所属・稼働。ファンとの親密な距離感と、丁寧なブランディングが特徴。",
            desc_en: "Features talent with unique concepts and models. Known for close fan interactions and meticulous branding.",
            desc_es: "Presenta talentos con conceptos y modelos únicos. Conocidos por su cercanía con los fans y un branding detallado.",
            desc_zh: "所属艺人拥有独特的概念和模型。特点是与粉丝之间的亲密距离感以及对IP品牌的细致塑造。",
            desc_ko: "독자적인 컨셉과 모델을 가진 탤런트들이 소속되어 활동합니다. 팬들과의 친밀한 거리감과 정교한 브랜딩이 특징입니다."
        },
        {
            name: "はなうさぎ",
            name_en: "Hanausagi",
            name_es: "Hanausagi",
            name_zh: "花兔 (Hanausagi)",
            name_ko: "하나우사기",
            sub: "Hanausagi",
            filter: "indie",
            color: "255, 180, 210",
            icon: "H",
            url: "Hanausagi/hanausagi_index.html",
            tags: ["Variety", "Music", "JP"],
            desc: "独自のモデルを持つタレントが所属し、音楽・バラエティを展開。明るく親しみやすい雰囲気を大切にしている。",
            desc_en: "Talents with unique models focus on music and variety. They value a bright, approachable, and friendly atmosphere.",
            desc_es: "Talentos con modelos únicos se enfocan en música y variedad. Valoran un ambiente brillante y cercano.",
            desc_zh: "拥有独特模型的艺人所属，主要开展音乐和综艺活动。非常看重开朗且富有亲和力的团内氛围。",
            desc_ko: "독자적인 모델을 가진 탤런트들이 소속되어 음악과 버라이어티 활동을 전개합니다. 밝고 친근한 분위기를 중시합니다."
        },
        {
            name: "my dear. production",
            name_en: "my dear. production",
            name_es: "my dear. production",
            name_zh: "my dear. production",
            name_ko: "마이 디어 프로덕션 (my dear.)",
            sub: "マイディア",
            filter: "indie",
            color: "220, 208, 255",
            icon: "M",
            url: "MyDear/mydear_index.html",
            tags: ["Worldview", "JP", "Agency"],
            desc: "独自のモデルと世界観を持つVTuberが所属・活動中。個々のキャラクター性を重視したマネジメントを行っている。",
            desc_en: "Home to VTubers with unique models and worldviews. Management emphasizes the development of individual character personalities.",
            desc_es: "Hogar de VTubers con modelos y mundos únicos. Su gestión enfatiza el desarrollo de las personalidades individuales de los personajes.",
            desc_zh: "拥有独特模型和世界观的VTuber所属并活跃中。在运营中十分重视发掘和展现每位角色的独特性格。",
            desc_ko: "독자적인 모델과 세계관을 가진 버추얼 유튜버들이 소속되어 활동 중입니다. 개별 캐릭터성을 중시한 매니지먼트를 수행합니다."
        },
        ...
        },
        {
            ...
            tags: ["EN", "Agency"],
            desc: "物語性を重視した海外プロジェクト。公式サイトでは独自の物語世界の設定が英語で綴られている。米国拠点。",
        ...
        },
        {
            ...
            color: "180, 30, 30",
            icon: "W",
            url: "WACTOR/wactor_index.html",
            tags: ["Global", "ES", "JP"],
            desc: "日本・スペイン語圏等で展開。独自のモデルを持つタレントが複数所属。多言語配信を積極的に行い、海外ファンの獲得に成功している。",
            desc_en: "Operates in Japan and Spanish-speaking regions. Actively broadcasts in multiple languages and has a large international following.",
            desc_es: "Opera en Japón y regiones de habla hispana. Transmite activamente en varios idiomas y cuenta con un gran número de seguidores internacionales.",
            desc_zh: "在日本、西班牙语圈等地开展活动。拥有多位专属模型的艺人。积极进行多语言直播，成功吸引了大量海外粉丝。",
            desc_ko: "일본 및 스페인어권 등지에서 전개됩니다. 독자적인 모델을 가진 탤런트들이 다수 소속되어 있습니다. 다국어 방송을 적극적으로 수행하며 해외 팬 확보에 성공했습니다."
        },
        {
            name: "Idol",
            name_en: "Idol Corp",
            ...
            color: "155, 89, 182",
            icon: "I",
            url: "IdolCorp/idolcorp_index.html",
            tags: ["EN", "Agency", "Major"],
            desc: "リン・ペンローズ（Rin Penrose）等、独自のガワで高い同時接続数を持つタレントが多数所属する英語圏の大手。",
            desc_en: "An English major home to talents with high concurrent viewership, like Rin Penrose, known for their unique character designs.",
            desc_es: "Una agencia importante de habla inglesa hogar de talentos con alta audiencia, como Rin Penrose, conocidos por sus diseños únicos.",
            desc_zh: "英语圈的大型事务所。所属艺人如リン・ペンローズ（Rin Penrose）等以独特的形象和极高的同时在线观看人数著称。",
            desc_ko: "린 펜로즈(Rin Penrose) 등 독자적인 캐릭터 디자인으로 높은 동시 시청자 수를 보유한 탤런트들이 다수 소속된 영어권의 대형 사무소입니다."
        },
        {
            name: "春魚クリエイティブ",
            name_en: "Spring Fish Creative",
            name_es: "Spring Fish Creative",
            name_zh: "春鱼创意",
            name_ko: "춘어 크리에이티브 (Spring Fish)",
            sub: "Spring Fish / TW",
            filter: "global",
            color: "173, 216, 230",
            icon: "S",
            url: "SpringFish/springfish_index.html",
            tags: ["TW", "Major", "Music"],
            desc: "台湾最大手。露恰露恰（Lucia）等、現地で高い認知度を持つ固有キャラクターが活動中。タイアップやイベントも活発。",
            desc_en: "Taiwan's largest agency. Local stars like Lucia are active here. They are highly active in collaborations and live events.",
            desc_es: "La agencia más grande de Taiwán. Estrellas locales como Lucia están activas aquí. Son muy activos en colaboraciones y eventos.",
            desc_zh: "台湾最大的VTuber团体。由露恰露恰（Lucia）等在当地具有极高知名度的专属角色进行活动。联动与线下活动也非常活跃。",
            desc_ko: "대만 최대 규모의 사무소입니다. 루치아(Lucia) 등 현지에서 높은 인지도를 가진 고유 캐릭터들이 활동 중입니다. 타이업이나 이벤트도 활발합니다."
        },
        {
            name: "箱箱Official",
            name_en: "Hakohako Official",
            name_es: "Hakohako Official",
            name_zh: "箱箱Official",
            name_ko: "하코하코 오피셜 (Hakohako)",
            sub: "箱箱 / TW",
            filter: "global",
            color: "255, 140, 0",
            icon: "H",
            url: "Hakohako/hakohako_index.html",
            tags: ["TW", "Variety", "Music"],
            desc: "台湾。森森鈴蘭等、歌唱・バラエティ特化の固有モデルタレントが稼働。音楽クオリティの高さがリスナーの支持を得ている。",
            desc_en: "Taiwan-based agency. Talent like Mori Rinran specialize in singing and variety. Highly supported for their musical quality.",
            desc_es: "Agencia con sede en Taiwán. Talentos como Mori Rinran se especializan en canto y variedad. Muy apoyados por su calidad musical.",
            desc_zh: "台湾事务所。旗下有森森铃兰等专注于唱歌和综艺特化的专属模型艺人。以极高的音乐水准赢得了听众的支持。",
            desc_ko: "대만 소재. 모리 린란 등 가창 및 버라이어티에 특화된 고유 모델 탤런트들이 활동 중입니다. 높은 음악적 퀄리티로 리스너들의 지지를 받고 있습니다."
        },
        {
            name: "Interlunium",
            name_en: "Interlunium",
            name_es: "Interlunium",
            name_zh: "Interlunium",
            name_ko: "인터루니움 (Interlunium)",
            sub: "インタールニウム / EN",
            filter: "global",
            color: "25, 25, 112",
            icon: "I",
            url: "Interlunium/interlunium_index.html",
            tags: ["EN", "Music", "Story"],
            desc: "英語圏。音楽・物語に特化した固有のキャラクターが所属し、定期的に活動。インディーながら高い制作クオリティを誇る。",
            desc_en: "English-speaking world. Talent specializing in music and stories broadcast regularly. Boasts high production quality despite being indie.",
            desc_es: "Mundo de habla inglesa. Talentos especializados en música e historias transmiten regularmente. Gran calidad de producción para un grupo indie.",
            desc_zh: "英语圈。所属艺人专注于音乐和故事的创作与演绎，定期进行活动。虽然是个人/独立性质但拥有极高的制作水准。",
            desc_ko: "영어권. 음악과 이야기에 특화된 고유 캐릭터들이 소속되어 정기적으로 활동합니다. 인디임에도 불구하고 높은 제작 퀄리티를 자랑합니다."
        },
        {
            name: "V-Dere",
            name_en: "V-Dere",
            ...
            color: "150, 0, 0",
            icon: "V",
            url: "VDere/vdere_index.html",
            tags: ["EN", "Agency", "Variety"],
            desc: "英語圏。中堅として複数のタレントが固有モデルで活動を継続。親しみやすい配信スタイルで中堅としての地位を確立。",
            desc_en: "English-speaking world. Multiple talents continue activities as a mid-tier group with unique models and friendly stream styles.",
            desc_es: "Mundo de habla inglesa. Varios talentos continúan sus actividades como un grupo de nivel medio con modelos únicos y estilos cercanos.",
            desc_zh: "英语圈。作为中坚力量，多位艺人以专属模型持续活跃中。凭借极具親和力の直播風格確立了其行业地位。",
            desc_ko: "영어권. 중견 그룹으로서 여러 탤런트가 고유 모델로 활동을 계속하고 있습니다. 친근한 방송 스타일로 중견으로서의 지위를 확립했습니다."
        },
        {
            name: "PixelLink",
            name_en: "PixelLink",
            name_es: "PixelLink",
            name_zh: "PixelLink",
            name_ko: "픽셀링크 (PixelLink)",
            sub: "ピクセルリンク / EN",
            filter: "global",
            color: "0, 255, 230",
            icon: "P",
            url: "PixelLink/pixellink_index.html",
            tags: ["EN", "Global", "Gaming"],
            desc: "英語圏の新鋭。独自のビジュアルとガワを持つグループ。勢いのある新メンバーを多数デビューさせ、急速に注目を集めている。",
            desc_en: "A rising star in the English world. With unique visuals and character designs, they've rapidly gained attention with successful new debuts.",
            desc_es: "Una estrella emergente en el mundo anglosajón. Con visuales y diseños de personajes únicos, han ganado atención rápidamente con nuevos debuts.",
            desc_zh: "英语圈的新锐势力。拥有独特视觉形象和外观模型的团体。接连推出了多位势头强劲的新成员，正迅速引起广泛关注。",
            desc_ko: "영어권의 신예. 독자적인 비주얼과 캐릭터 디자인을 가진 그룹입니다. 기세 좋은 신규 멤버들을 다수 데뷔시키며 급속히 주목받고 있습니다."
        },
