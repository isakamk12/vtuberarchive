document.addEventListener('DOMContentLoaded', () => {
    ...
    const agencies = [
        ...
        },
        {
            ...
            color: "50, 255, 200",
            icon: "S",
            url: "Synthmaniacs/synth_index.html",
            tags: ["Music", "Synth"],
        ...
        },
        {
            ...
            color: "180, 180, 200",
            icon: "P",
            url: "ProFormaNova/proforma_index.html",
            tags: ["Agency", "JP"],
        ...
        },
        {
            ...
            color: "200, 200, 255",
            icon: "M",
            url: "MarbleCreators/marble_index.html",
            tags: ["Creator", "JP"],
        ...
        },
        {
            ...
            color: "150, 200, 255",
            icon: "S",
            url: "StellarVerse/stellarverse_index.html",
            tags: ["EN", "Agency"],
