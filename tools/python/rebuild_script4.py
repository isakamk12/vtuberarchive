...
if 'const app = createApp' not in text:
    ...
    if agencies_start != -1:
        ...
        start_bracket = text.find('[', agencies_start)
        ...
        if end_bracket != -1:
            # We want everything including "const agencies =" and the terminating bracket and semicolon
            agencies_str = text[agencies_start:end_bracket+1] + ';'
...
'''
            ...
            print("Failed to find end bracket of agencies!")
    else:
        print("Could not find start of agencies!")
else:
