...
if 'const app = createApp' not in text:
    ...
    translations_end = text.find('function ', translations_start)
    
    print(f"agencies_start: {agencies_start}")
    print(f"agencies_end: {agencies_end}")
    print(f"translations_start: {translations_start}")
    print(f"translations_end: {translations_end}")

    if agencies_start != -1 and agencies_end != -1 and translations_start != -1 and translations_end != -1:
