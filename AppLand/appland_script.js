...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ja: {
            ...
            hero_eyebrow: 'バーチャルYouTuberプロダクション',
            ...
            group_founders: '👑 創設者・レジェンド',
            group_idol: '🌸 元アイドル部',
            group_2021: '✨ 2021世代 (Mirikurun)',
            group_new: '🌟 新メンバー',
            division_vpi: 'ぶいぱい (VPI Cafe)',
            group_gen1: '🍓 1期生',
            group_gen2: '🍒 2期生',
            group_gen3: '🍇 3期生',
            group_alumni: '🎓 卒業・活動終了メンバー',
            footer_note: '© 2026 VTuber Archive Project. 非公式ファンアーカイブ。APP LANDとは無関係です。'
        },
        en: {
            title: 'APP LAND | VTuber Archive',
            ...
            nav_back: 'BACK TO HUB',
            nav_tag: 'VTuber Production ".LIVE"',
            hero_eyebrow: 'Virtual YouTuber Production',
            ...
            section_roster_sub: 'TALENT ROSTER',
            group_founders: '👑 Founders & Legends',
            group_idol: '🌸 Former Idol Club',
            group_2021: '✨ 2021 Class (Mirikurun)',
            group_new: '🌟 New Members',
            division_vpi: 'VPI Cafe (ぶいぱい)',
            group_gen1: '🍓 Generation 1',
            group_gen2: '🍒 Generation 2',
            group_gen3: '🍇 Generation 3',
            group_alumni: '🎓 Alumni',
            footer_note: '© 2026 VTuber Archive Project. Unofficial fan archive. Not affiliated with APP LAND.'
        },
        de: {
            title: 'APP LAND | VTuber Archive',
            ...
            nav_tag: 'VTuber Production ".LIVE"',
            hero_eyebrow: 'Virtuelle YouTuber Production',
            ...
            section_roster: 'Talent Roster',
            section_roster_sub: 'TALENT ROSTER',
            group_founders: '👑 Grunder und Legenden',
            group_idol: '🌸 Ehemaliger Idol Club',
            group_2021: '✨ Jahrgang 2021 (Mirikurun)',
            group_new: '🌟 Neue Mitglieder',
            division_vpi: 'VPI Cafe (ぶいぱい)',
            group_gen1: '🍓 1. Generation',
            group_gen2: '🍒 2. Generation',
            group_gen3: '🍇 3. Generation',
            group_alumni: '🎓 Alumni',
            footer_note: '© 2026 VTuber Archive Project. Inoffizielles Fan-Archiv. Nicht mit APP LAND verbunden.'
        },
        fr: {
            title: 'APP LAND | VTuber Archive',
            ...
            nav_tag: 'VTuber Production ".LIVE"',
            hero_eyebrow: 'Production de Virtual YouTuber',
            ...
            section_roster: 'Talent Roster',
            section_roster_sub: 'TALENT ROSTER',
            group_founders: '👑 Fondateurs et legendes',
            group_idol: '🌸 Ancien Idol Club',
            group_2021: '✨ Generation 2021 (Mirikurun)',
            group_new: '🌟 Nouveaux membres',
            division_vpi: 'VPI Cafe (ぶいぱい)',
            group_gen1: '🍓 1re generation',
            group_gen2: '🍒 2e generation',
            group_gen3: '🍇 3e generation',
            group_alumni: '🎓 Alumni',
            footer_note: '© 2026 VTuber Archive Project. Archive de fans non officielle. Non affilie a APP LAND.'
        },
        es: {
            title: 'APP LAND | VTuber Archive',
            ...
            nav_tag: 'VTuber Production ".LIVE"',
            hero_eyebrow: 'Produccion de Virtual YouTuber',
            ...
            section_roster: 'Talent Roster',
            section_roster_sub: 'TALENT ROSTER',
            group_founders: '👑 Fundadores y leyendas',
            group_idol: '🌸 Antiguo Idol Club',
            group_2021: '✨ Generacion 2021 (Mirikurun)',
            group_new: '🌟 Nuevos miembros',
            division_vpi: 'VPI Cafe (ぶいぱい)',
            group_gen1: '🍓 Generacion 1',
            group_gen2: '🍒 Generacion 2',
            group_gen3: '🍇 Generacion 3',
            group_alumni: '🎓 Alumni',
            footer_note: '© 2026 VTuber Archive Project. Archivo de fans no oficial. No afiliado a APP LAND.'
        },
        pt: {
            title: 'APP LAND | VTuber Archive',
            ...
            nav_tag: 'VTuber Production ".LIVE"',
            hero_eyebrow: 'Producao de Virtual YouTuber',
            ...
            section_roster: 'Talent Roster',
            section_roster_sub: 'TALENT ROSTER',
            group_founders: '👑 Fundadores e lendas',
            group_idol: '🌸 Ex-Idol Club',
            group_2021: '✨ Geracao 2021 (Mirikurun)',
            group_new: '🌟 Novos membros',
            division_vpi: 'VPI Cafe (ぶいぱい)',
            group_gen1: '🍓 Geracao 1',
            group_gen2: '🍒 Geracao 2',
            group_gen3: '🍇 Geracao 3',
            group_alumni: '🎓 Alumni',
            footer_note: '© 2026 VTuber Archive Project. Arquivo de fans nao oficial. Nao afiliado a APP LAND.'
        },
        zh: {
            title: 'APP LAND | VTuber Archive',
            ...
            section_roster: '成员列表',
            section_roster_sub: 'TALENT ROSTER',
            group_founders: '👑 创始者与传奇',
            group_idol: '🌸 前偶像部',
            group_2021: '✨ 2021 世代 (Mirikurun)',
            group_new: '🌟 新成员',
            division_vpi: 'ぶいぱい (VPI Cafe)',
            group_gen1: '🍓 1 期生',
            group_gen2: '🍒 2 期生',
            group_gen3: '🍇 3 期生',
            group_alumni: '🎓 毕业成员',
            footer_note: '© 2026 VTuber Archive Project. 非官方粉丝归档。与 APP LAND 无关。'
        },
        ko: {
            title: 'APP LAND | VTuber Archive',
            ...
            section_roster_sub: 'TALENT ROSTER',
            group_founders: '👑 창립자와 레전드',
            group_idol: '🌸 전 아이돌부',
            group_2021: '✨ 2021 세대 (Mirikurun)',
            group_new: '🌟 신규 멤버',
            division_vpi: 'ぶいぱい (VPI Cafe)',
            group_gen1: '🍓 1기생',
            group_gen2: '🍒 2기생',
            group_gen3: '🍇 3기생',
            group_alumni: '🎓 졸업/활동 종료 멤버',
            footer_note: '© 2026 VTuber Archive Project. 비공식 팬 아카이브. APP LAND와 무관합니다.'
        },
        id: {
            title: 'APP LAND | VTuber Archive',
            ...
            nav_tag: 'VTuber Production ".LIVE"',
            hero_eyebrow: 'Produksi Virtual YouTuber',
            ...
            section_roster_sub: 'TALENT ROSTER',
            group_founders: '👑 Pendiri dan legenda',
            group_idol: '🌸 Mantan Idol Club',
            group_2021: '✨ Angkatan 2021 (Mirikurun)',
            group_new: '🌟 Member baru',
            division_vpi: 'ぶいぱい (VPI Cafe)',
            group_gen1: '🍓 Generasi 1',
            group_gen2: '🍒 Generasi 2',
            group_gen3: '🍇 Generasi 3',
            group_alumni: '🎓 Alumni',
            footer_note: '© 2026 VTuber Archive Project. Arsip penggemar tidak resmi. Tidak berafiliasi dengan APP LAND.'
        }
    };
